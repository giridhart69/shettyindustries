        ...
        <div className="flex justify-between items-center h-16">
          ...
          <Link to="/" className="flex items-center space-x-3 group">
            <div className="p-0 rounded-lg">
              <img
                src="https://i.postimg.cc/QHw1DhVb/si-TP.png"
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <div className="relative group">
              ...
              <div className="absolute top-full right-0 mt-2 w-64 bg-black shadow-xl rounded-lg border border-gray-600 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform group-hover:translate-y-0 translate-y-2 z-50">
                <div className="p-2">
                  <NavLink
                    to="/blazehigh-ai"
